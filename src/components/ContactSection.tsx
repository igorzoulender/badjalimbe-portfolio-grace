    ...
    <section id="contact" className="py-20 relative">
      ...
      <div ref={sectionRef} className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <div className="space-y-8">
            <div className="contact-element">
              ...
              <p className="text-foreground/80 text-lg mb-8 leading-relaxed">
                ...
                je suis toujours prêt à relever de nouveaux défis et à contribuer à des projets ambitieux.
              </p>
            </div>
              ...
              {contactInfo.map((contact, index) => (
                <div key={index} className="contact-element">
                  ...
                  >
                    ...
                    <div>
                      <p className="text-sm text-foreground/70">{contact.label}</p>
            ...
            <div className="contact-element">
              <div className="cyber-border p-6 rounded-lg">
                ...
                <div className="grid grid-cols-2 gap-3">
                  {["Rigueur", "Adaptabilité", "Innovation", "Leadership", "Résolution", "Excellence"].map((quality, index) => (
          ...
          {/* Contact Form */}
          <div className="contact-element">
            <form className="space-y-6 cyber-border p-8 rounded-lg">
              ...
              <Button 
                type="submit" 
                className="w-full cyber-border bg-primary hover:bg-primary/80 text-primary-foreground"
                size="lg"
              >
